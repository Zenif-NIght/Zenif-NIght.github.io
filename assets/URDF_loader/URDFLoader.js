    ...
    parse(content) {
        ...
        function processLinkElement(vn, materialMap = {}) {
            ...
            if (materialNode) {
                ...
                material = new THREE.MeshStandardMaterial({color:new THREE.Color( 0xff0000 )});
    ...
    defaultMeshLoader(path, manager, done) {
        ...
        if (/\.stl$/i.test(path)) {
            ...
            loader.load(path, geom => {
                const mesh = new THREE.Mesh(geom, new THREE.MeshStandardMaterial({color:new THREE.Color( 0x00ff00 )}));
                done(mesh);
            });
